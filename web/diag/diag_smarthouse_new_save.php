...
.item{
    ...
    margin-top:-50px;
          ...
          <?php
            ...
            $result = mysql_query("INSERT INTO ewc_behaviour_signal(input_ewc, output_ewc, delay, type, metadata) VALUES('$input','$output','$delay','$type','$metadata')");        
