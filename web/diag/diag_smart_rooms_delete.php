          ...
          <div class="span4 responsive" data-tablet="span4 fix-margin" data-desktop="span4">
                ...
                <div class="span4 responsive" data-tablet="span4 fix-margin" data-desktop="span4">
                    ...
                    <div class="widget orange">
                        ...
                        <div style="text-align:center">
                          <p>
                            <a href="<?php echo"?menu=$menu&process=8&command=1&idcko=$idcko";?>"><button class="btn btn-large btn-danger"><i class="icon-remove icon-white"></i> ANO</button></a>
