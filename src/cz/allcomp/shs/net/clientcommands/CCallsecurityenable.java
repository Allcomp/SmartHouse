...
public class CCallsecurityenable extends ClientCommand {

	public CCallsecurityenable(String cmd) {
		super(cmd);
	}
	...
	public ClientCommand copy() {
		return new CCallsecurityenable(this.getCommand());
	}
